...
phonesRoutes.post("/create/:owner_id",verifyTokenMiddleware,schemaValidatedMiddleware(phonesSchema),phoneCreateController)
phonesRoutes.delete("/delete/:id", verifyTokenMiddleware,phoneDeleteController)
phonesRoutes.patch("/update/:id", verifyTokenMiddleware,schemaValidatedMiddleware(phoneUpdateSchema),phoneUpdateController)
