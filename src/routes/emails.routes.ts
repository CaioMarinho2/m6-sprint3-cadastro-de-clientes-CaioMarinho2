...
emailsRoutes.post("/create/:contact_id",verifyTokenMiddleware,schemaValidatedMiddleware(emailsSchema),emailCreateController)
emailsRoutes.delete("/delete/:id",verifyTokenMiddleware,emailDeleteController)
emailsRoutes.patch("/update/:id",verifyTokenMiddleware,schemaValidatedMiddleware(emailsUpdateSchema),emailUpdateController)
